...
export const ACHIEVEMENTS: AchievementDef[] = [
	...
	{ id: 'div_tesla', name: 'Electric Dreams', description: 'Unlock EVs division', icon: '🚗', category: 'divisions',
	...
	{ id: 'tier_all_tesla', name: 'Full Lineup', description: 'Unlock all Tesla tiers', icon: '🚗', category: 'divisions',
