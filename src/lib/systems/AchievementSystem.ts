...
export const ACHIEVEMENTS: AchievementDef[] = [
	...
	{ id: 'div_ai', name: 'Rise of the Machines', description: 'Unlock AI division', icon: '🤖', category: 'divisions',
		condition: (s) => s.divisions.ai.unlocked },
	{ id: 'div_tunnels', name: 'Going Underground', description: 'Unlock Tunnels division', icon: '🚇', category: 'divisions',
		condition: (s) => s.divisions.tunnels.unlocked },
	{ id: 'div_robotics', name: 'Automation Nation', description: 'Unlock Robotics division', icon: '🦾', category: 'divisions',
		condition: (s) => s.divisions.robotics.unlocked },
	{ id: 'tier_all_spacex', name: 'Full Stack Rockets', description: 'Unlock all Rockets tiers', icon: '🚀', category: 'divisions',
	...
	{ id: 'tier_all_ai', name: 'Singularity', description: 'Unlock all AI tiers', icon: '🤖', category: 'divisions',
		condition: (s) => s.divisions.ai.tiers.every(t => t.unlocked) },
	{ id: 'tier_all_tunnels', name: 'Mole King', description: 'Unlock all Tunnels tiers', icon: '🚇', category: 'divisions',
		condition: (s) => s.divisions.tunnels.tiers.every(t => t.unlocked) },
	{ id: 'tier_all_robotics', name: 'Robot Army', description: 'Unlock all Robotics tiers', icon: '🦾', category: 'divisions',
